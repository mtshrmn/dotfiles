...
bg_hint = "#ff795f"
fg_hint = "#c8ccd4"
fg_matched_text = "#ff795f"
bg_passthrough_mode = "#dd672c"
bg_insert_mode = "#6e88a6"
bg_warning = "#ff795f"
...
c.colors.statusbar.progress.bg = bg_lightest
c.colors.statusbar.url.fg = bg_lightest
c.colors.statusbar.url.success.http.fg = fg_error
c.colors.statusbar.url.success.https.fg = bg_lightest
