...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-cmp', 'nvim-lsp-installer', 'null-ls.nvim', 'Comment.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
