...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'FixCursorHold.nvim', 'nvim-lsp-installer', 'null-ls.nvim', 'lspsaga.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'nvim-cmp', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
