...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'Comment.nvim', 'nvim-lsp-installer', 'nvim-treesitter', 'lspsaga.nvim', 'gitsigns.nvim', 'nvim-lspconfig', 'null-ls.nvim', 'nvim-colorizer.lua', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
