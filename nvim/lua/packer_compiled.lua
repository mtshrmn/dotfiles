...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'nvim-lspconfig', 'FixCursorHold.nvim', 'null-ls.nvim', 'Comment.nvim', 'lspsaga.nvim', 'gitsigns.nvim', 'nvim-cmp', 'nvim-lsp-installer'}, { event = "BufRead *" }, _G.packer_plugins)]]
